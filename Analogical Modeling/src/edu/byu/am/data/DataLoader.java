...
public class DataLoader {
	 ...
	 * 
	 * @param regex
	 *            Regex to split a line on.
	 */
	public void setFeatureSeparator(String regex) {
		sepString = regex;
	}
	 ...
	 * 
	 * @param sep
	 *            String intended to demarcate comments; \#by default.
	 */
	 ...
	 * 
	 * @param i
	 *            Index of feature which indicates the outcome for the given
	 *            vector. The default, -1, will cause the loader to use the
	 *            feature in each vector as the outcome.
	 */
	 ...
	 * 
	 * @param fileName
	 * @return {@link java.util.LinkedList [LinkedList]} of {@link Exemplar
	 *         [Exemplars]}, each corresponding to one line of the file.
	 * @throws IOException
	 */
	public LinkedList<Exemplar> exemplars(String fileName) throws IOException {
		...
		for (LinkedList<String> sl : data) {
			try {
				...
				System.err
						.println("IndexOutOfBoundsException while accessing the outcome, index "
	 ...
	 * @param name
	 *            of exemplar file
	 * @return List of String arrays. The first element will be the outcome, and
	 *         the rest are features.
	 * @throws IOException
	 *             if the file is empty.
	 * @throws IllegalArgumentException
	 *             if a line has the wrong number of features on it. The correct
	 *             number of features is determined from the first line in the
	 *             file.
	 */
	 ...
	 * @param regex
	 *            to split on
	 * @return split string array after removing all empty strings. Prevents
	 *         creating false empty features.
	 ...
	 * 
	 * @return the next valid line, with comments and leading/trailing
	 *         whitespace removed, or null if there isn't one.
	 */
