...
public class AnalogicalSet {
	...
	private final List<Supracontext> supraList;
	 ...
	 *            quadratically.
	 */
	public AnalogicalSet(List<Supracontext> list, Instance testItem,
			boolean linear) {
		...
		exPointerMap = getPointers(list, linear);
	 ...
	 *         it.
	 */
	private Map<Instance, BigInteger> getPointers(List<Supracontext> list,
			boolean linear) {
