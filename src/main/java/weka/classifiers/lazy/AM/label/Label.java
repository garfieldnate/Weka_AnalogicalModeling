...
public abstract class Label {
     ...
     * @throws IllegalArgumentException if the index is less than 0 or greater than {@link #getCardinality} - 1.
     */
     ...
     *
     * @param possibleAncestor possible label ancestor
     * @return true if possibleAncestor is an ancestor of this label; false otherwise.
     */
     ...
     *
     * @param otherLabel the label to intersect with this one
