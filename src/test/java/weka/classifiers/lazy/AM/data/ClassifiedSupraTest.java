...
public class ClassifiedSupraTest {
    ...
    public static void setUpBeforeClass() throws Exception {
        ...
        double[][] data = new double[][]{
            new double[]{1, 1}, new double[]{1, 0}, new double[]{0, 0}
        };
    ...
    private void assertCausesHeterogeneity(ClassifiedSupra supra, Subcontext sub, boolean causes) {
    ...
    public void testOutcome() {
        ...
        Set<Subcontext> subSet;

        subSet = new HashSet<>();
        subSet.add(subs.get(3));// 0
        subSet.add(subs.get(4));// 0
        double DELTA = 1e-10;
        assertEquals(new ClassifiedSupra(subSet, count).getOutcome(), 0.0, DELTA);
        testSupra = new ClassifiedSupra();
        ...
        assertEquals(new ClassifiedSupra(subSet, count).getOutcome(), 1.0, DELTA);
        testSupra = new ClassifiedSupra();
        ...
        assertEquals(new ClassifiedSupra(subSet, count).getOutcome(), AMUtils.NONDETERMINISTIC, DELTA);
        testSupra = new ClassifiedSupra();
